				...
				Lungo.dom('#btn_next_Regis1').tap(function() { 
					...
					if(ids==''){
						...
						$$.ajax({
							crossDomain: true,
							type:'POST',
							url: 'http://localhost/buscame/buscame/app/components/php/buscameData.php?data=nextCat&idsCat='+ids,
							dataType: 'html',
							async: true,
				...
				Lungo.dom('#btn_next_Regis2').tap(function() { 
					...
					if(ids==''){
						...
						$$.ajax({
							crossDomain: true,
							type:'POST',
							url: 'http://localhost/buscame/buscame/app/components/php/buscameData.php?data=nextTipo&idsTipo='+ids+'&usuario='+localStorage.usuario,
							dataType: 'html',
							async: true,
							success: function(data) {
								if(data){
